...
class SimpleSettingsPage2 extends StatefulWidget {
  const SimpleSettingsPage2({Key? key}) : super(key: key);

  @override
  State<SimpleSettingsPage2> createState() => _SimpleSettingsPageState();
}

class _SimpleSettingsPageState extends State<SimpleSettingsPage2> {
  bool _isDark = false;
  @override
