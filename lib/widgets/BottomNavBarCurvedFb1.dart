...
class BottomNavBarCurvedData extends StatelessWidget {
  const BottomNavBarCurvedData({super.key});

  @override
  Widget build(BuildContext context) {
    return Container(
        padding: const EdgeInsets.symmetric(vertical: 20.0, horizontal: 0),
        child: BottomNavBarCurvedFb1(), decoration: BoxDecoration(color: Colors.green));
  }
}
