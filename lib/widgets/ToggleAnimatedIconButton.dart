...
class ToggleAnimatedIconButtonWithData extends StatelessWidget {
  const ToggleAnimatedIconButtonWithData({super.key});

  @override
  Widget build(BuildContext context) {
    return ToggleAnimatedIconButton(
...
class ToggleAnimatedIconButtonDisplayCode {
