...
class LoadingAnimatedButtonData extends StatelessWidget {
  const LoadingAnimatedButtonData({super.key});

  @override
  Widget build(BuildContext context) {
    return LoadingAnimatedButton(child: Container(
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(15), color: Colors.white),
        padding: const EdgeInsets.symmetric(horizontal: 65, vertical: 10),
        child: Text("Loading")), onTap: () {});
  }
}
...
class LoadingAnimatedButtonCode {
